  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "liquid-glass",
        isDragActive ? "border-indigo-500 bg-indigo-500/10 scale-[1.02]" : "border-white/10 hover:border-white/20 hover:bg-white/5",
        className
      )}
    >
      <input {...getInputProps()} />
      ...
      <p className="text-xl font-bold text-white mb-2 text-center">{label}</p>
